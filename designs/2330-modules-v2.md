...
- Performance:
    - Cloning repositories can be costly. Under a VCS-based module design, long
      ...
      not VCS-based side steps such challenges.
- Enhanced security:
...
automated validation during publishing and prevents accidents. We plan to provide
...
a major vs minor vs patch release are closely related to the concept of [backwards
